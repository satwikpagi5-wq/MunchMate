  ...
  return (
    <div className="px-4 py-12 max-w-4xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 max-w-sm mx-auto">Tell us how you feel, and we'll reveal your perfect canteen match.</p>
      </div>
        ...
        <div className="md:col-span-1 space-y-4">
          ...
          {moods.map(m => (
            <button
              ...
              className="w-full p-4 bg-white border border-gray-100 rounded-2xl text-sm font-medium text-left hover:border-purple-200 hover:bg-purple-50/50 transition-all group"
            >
              {m}
            </button>
          ))}
          ...
          <div className="relative mt-8">
            <input 
              ...
              className="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-purple-500 outline-none pr-12 text-sm"
            />
            <button 
          ...
          <AnimatePresence mode="wait">
            {loading ? (
              <motion.div 
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="w-full h-full border-2 border-dashed border-purple-100 rounded-[48px] flex flex-col items-center justify-center p-12 text-center"
              >
                <div className="w-16 h-16 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mb-6 animate-spin">
                  <BrainCircuit size={32} />
                </div>
                <h3 className="text-xl font-bold mb-2">Analyzing your cravings...</h3>
                <p className="text-gray-400 text-sm">Consulting with our expert AI chef at PU Goa.</p>
              </motion.div>
            ) : suggestion ? (
              <motion.div 
                key="suggestion"
                ...
                className="w-full bg-white border border-gray-100 rounded-[48px] overflow-hidden shadow-2xl shadow-purple-500/5"
              >
                <div className="relative h-64">
                   <img src={suggestion.item.image} className="w-full h-full object-cover" />
                ...
                <div className="p-8 space-y-6">
                   <div>
                     ...
                     <p className="text-gray-600 leading-relaxed italic">"{suggestion.reason}"</p>
                   </div>

                   <div className="p-4 bg-purple-50 rounded-2xl flex gap-3">
                      <div className="text-purple-600 shrink-0"><Info size={20} /></div>
                      <div>
                        <p className="text-[10px] font-black uppercase text-purple-400 mb-1">Campus Tip</p>
                        <p className="text-xs text-purple-900 font-medium">{suggestion.funFact}</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-center justify-between pt-4">
                      <div>
                        ...
                        <p className="text-2xl font-black">₹{suggestion.item.price}</p>
                      </div>
                      <button 
                      ...
                      <button className="px-8 py-4 bg-gray-900 text-white rounded-2xl font-bold hover:bg-purple-600 transition-all flex items-center gap-2">
              ...
              <motion.div 
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="w-full h-full border-2 border-dashed border-gray-100 rounded-[48px] flex flex-col items-center justify-center p-12 text-center text-gray-400"
              >
                <Sparkles className="mb-6 opacity-10" size={80} />
                <h3 className="text-lg font-bold mb-2">Ready to explore?</h3>
                <p className="text-sm">Select a mood or describe what you want to eat.</p>
              </motion.div>
            )}
          </AnimatePresence>
